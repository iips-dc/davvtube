...
$result = mysqli_query($con,"SELECT * FROM video_list WHERE file_name LIKE '%".$_POST['search']."%' OR tags LIKE '%".$_POST['search']."%' OR description LIKE '%".$_POST['search']."%' OR title LIKE '%".$_POST['search']."%'");
 ?>
