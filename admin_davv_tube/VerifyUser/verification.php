        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
			...
			<li><a href="verification.php">Student</a></li>
			 ...
			 <li class="dropdown"><a href="<?php echo $host.$folderName;?>/admin_davv_tube/admin_forum/verify_post.php" class="dropdown-toggle" data-toggle="dropdown">Comments<b class="caret"></b></a>
			<ul class="dropdown-menu">
			<li><a href="<?php echo $host.$folderName;?>/admin_davv_tube/admin_forum/verify_post.php">Pending Comments</a></li>
...
-->
					  ...
					  <td>
					   ...
					   <td>
						  <span data-bind="text: lname"></span>
					  					   ...
					  					   <td>
						  <span data-bind="text: enroll"></span>
						  ...
						  <span data-bind="text: roll"></span>
					  					   ...
					  					   <td>
						  <span data-bind="text: course"></span>
	...
	<script>
		...
		var personModel = function(id, name, age,email,status,dept,lname,enroll,roll,course,sem){
			 ...
			 $.ajax({
				  ...
				  success: function(data){ //json string of the student records returned from the server
					  ...
					  for(var x in data){
						  ...
						  var enroll=data[x]['enroll'];
						  var roll=data[x]['roll'];
						  var course=data[x]['course'];
						  var sem=data[x]['sem'];

						  //push each of the student record to the observable array for 
						  //storing student data
						  
						  self.people.push(new personModel(id, name, age,email,status,dept,lname,enroll,roll,course,sem));
					  }
