...
<title>Faculty Registration</title>
 <!-- Bootstrap core CSS -->
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	var senNo=document.forms["reg"]["sen_no"].value;
	
	var lname=document.forms["reg"]["l_name"].value;
	var designation=document.forms["reg"]["designation"].value;
	...
	/* if(gender=="" || gender==null)
	 ...
	 if(senNo=="" || senNo==null)
	 {msg+="\n University Seniority number must be enter";
	 flag=false;
	 }
	 if(designation=="" || designation==null)
	 {msg+="\n Designation must be enter";
	 flag=false;
	 }
...
<form action="faculty_submit.php" name = "reg" method="post" enctype="multipart/form-data">
...
<h4>Department *</h4><select name='category' id='category' placeholder="Enter Your Department" value=1 class="form-control required" size='1' onchange="return Selected('category')"></select>
		  ...
		  -->
		  <h4>Designation *</h4>
		  <input type="text" name="designation" placeholder="Enter Your Designation"  class="form-control required" title="Please Enter Your Designation">
		 
		  <h4>University Seniority Number *</h4>
		  <input type="text"  name="sen_no" placeholder="University Seniority Number" class="form-control required"  title="Please Enter Your University Seniority Number">
